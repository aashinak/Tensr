  ...
  method = "signin",
    ...
    return (
      <div className="w-11/12 flex flex-col justify-center mx-auto mt-4 space-y-3 md:space-y-5">
        <Button
          iconSrc="/google.svg"
          className="w-full font-semibold text-[#d1d1d1] shadow-[inset_0_0_0_0.8px_#414141] hover:bg-white/5  "
        ...
        <Button
          ...
          className="w-full font-bold shadow-[inset_0_0_0_0.8px_#414141] hover:bg-white/5 text-[#d1d1d1]"
